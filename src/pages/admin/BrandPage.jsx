...
const AdminBrands = () => {
  ...
  // ✅ FIX: useCallback ensures function reference remains stable
  ...
  const handleAddBrand = async (e) => {
    ...
    try {
      ...
      // Agar 403 aaye to user ko batao
...
//upper code is the fixed code but same fir fetch brands function 
// import React, { useEffect, useState, useCallback } from 'react';
// import api from '../../services/api';
